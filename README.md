...
* Drive and Actuation System:
	The main chassis houses the inner components with the forks positioned at the front. These forks are capable of lifting heights up to 210mm with the ability to counter tilt and adjust for inclines. 

* Power Systems:
	It is configured with a rechargeable battery with operation times of about 5 hours with charging times no longer than 2 hours. 

* Control and Monitoring Infrastructure:
	It contains 4G and Wi-Fi modules with support to be controlled remotely and to customize the scheduling of operation time and sends data to be monitored. 
